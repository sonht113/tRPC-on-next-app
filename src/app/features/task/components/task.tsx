...
const Task: FC<Props> = ({ typeTask, data }) => {
  return (
    <div className='w-[90%] h-[150px] flex justify-between px-3 py-3 rounded-lg mx-auto bg-gray-400 mb-3'>
      <div className='flex flex-col justify-between'>
        ...
        {data.schedule && <TagTimeStatus schedule={data.schedule as keyof typeof SCHEDULE} status={data.status} />}
      </div>
      <div className={`flex flex-col gap-2 justify-${typeTask === "todo" ? "center" : "start"} items-end`}>
